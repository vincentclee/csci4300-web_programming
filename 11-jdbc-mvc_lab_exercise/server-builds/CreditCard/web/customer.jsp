...
function CheckForm() {
	...
	//Checks that Merchant Name can fit into the database varchar(100)
	if (document.forms[0].merchantName.value.length > 100) {
		alert("Merchant name is too long.");
		return false;
    }
	...
	//Checks that merchant city can fit into the database varchar(50)
	if (document.forms[0].merchantCity.value.length > 50) {
		alert("Merchant city is too long.");
		return false;
	}
