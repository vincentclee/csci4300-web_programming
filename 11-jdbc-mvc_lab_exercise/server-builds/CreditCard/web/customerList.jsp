...
function CheckForm() {
	...
	//Checks that Customer Name can fit into the database varchar(100)
	if (document.forms[0].custName.value.length > 100) {
	...
	//Checks that Customer Address can fit into the database varchar(100)
	if (document.forms[0].custAddr.value.length > 100) {
		alert("Customer address is too long.");
		return false;
	}
	...
	//Checks that Image URL can fit into the database varchar(500)
	if (document.forms[0].imageURL.value.length > 500) {
