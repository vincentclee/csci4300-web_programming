...
* http://igorstravinskij.blogspot.com/2008/04/flickr-horizontal-menu-with-prototype.html
...
submenu.hide();
this.writeAttribute('src','/reporting/images/arrow_hover.png');
} else {
headMenu.addClassName("active");
submenu.setStyle({'display': 'block'});
this.writeAttribute('src','/reporting/images/arrow_select.png');
}
...
if(e != this){
  e.writeAttribute('src','/reporting/images/arrow.png');
}
});
...
submenu = e.findElement('li').down(3);
if(submenu.getStyle('display')!='block'){
 this.writeAttribute('src','/reporting/images/arrow.png');
} else {
 this.writeAttribute('src','/reporting/images/arrow_select.png');
}
});
...
if (elt == undefined){
 ...
 $$("#nicemenu img.arrow").invoke('writeAttribute','src','/reporting/images/arrow.png');
}});
