...
system("rm -Rf CSVFiles/course_offering_UNIV_201308.csv");

## Download latest file: course_offering_UNIV_201308.csv ##
## https://apps.reg.uga.edu/reporting/staticReports ##
system("wget --secure-protocol=SSLv3 -P CSVFiles/ https://apps.reg.uga.edu/reporting/static_reports/course_offering_UNIV_201308.csv");

## Change the permissions so mysql can use it ##
system("chmod 775 CSVFiles/course_offering_UNIV_201308.csv");
...
system("mv -f CSVFiles/course_offering_UNIV_201308.csv CSVFiles/backups/course_offering_UNIV_201308_$(date '+%Y_%m_%d_%H_%M_%S').csv");
