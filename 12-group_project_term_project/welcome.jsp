		...
		<div class="maincontent">
			<h1>Instructions</h1>
				<p>Click on a requirement to the left to view classes that will fulfill that requirement.<br>
                                   ...
                                   When viewing schedule, you can delete one or multiple classes by selecting and pressing the "delete" button.<br>
                                   <br><br><br><br>
                                  
                                   
                                    <a href="http://www.adobe.com/go/adc_css_layouts">http://www.adobe.com/go/adc_css_layouts</a>.</p>
		<!-- end .maincontent --></div>
	<!-- end .content --></div>
