...
public class CourseController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("userName") != null) {
			...
			Schedule schedule = new Schedule((ArrayList<String>)session.getAttribute("scheduleList"), (LinkedHashMap<String, List<String>>)request.getSession().getAttribute("scheduleTree"), (ArrayList<LinkedHashMap<String, List<String>>>) session.getAttribute("coursesTree"));
			...
			@SuppressWarnings("unchecked")
			Schedule schedule = new Schedule((ArrayList<String>)session.getAttribute("scheduleList"), (LinkedHashMap<String, List<String>>)request.getSession().getAttribute("scheduleTree"));
